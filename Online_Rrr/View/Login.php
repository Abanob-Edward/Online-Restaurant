...
<?php $title = 'Log in'; 
$ico = '../Images/F_img/ico/login.ico';
session_start();
?>
                        ...
                        <div class="form-03-main">
                                      ...
                                      <form action="../Controller/login.php" method="POST">
                                        ...
                                        <div class="form-group p-10 wow bounceInRight " data-wow-delay="0.2s">
                                            <input type="text" class="form-control fa" name="email" placeholder="&#xf0e0; Enter Username">
                                        </div>

                                        <div class="form-group  wow bounceInRight " data-wow-delay="0.2s">
                                        
                                            <input type="password" class="form-control fas" name="password" placeholder="&#xf084; Enter Password">
                                        </div>
                                        ...
                                        <div class="form-group p-0 wow wobble " data-wow-delay="0.6s">
                                            <div class="_btn_04 ">
                                                <input type="submit" name="submit" value="Log In" class="btn_log" />
                                            </div>
                                           
                                        </div>
                                        <div class="checkbox form-group">
                                        <a class="text-light" href="Register.php">Don't Have Account</a>
                                         </div>
